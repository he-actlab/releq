...
class RLQuantization:
    ...
    def quantize_layer(self, episode_num, layer_num, bitwidth_layers, quant_state, accuracy):
        ...
        for i in range(self.n_act_p_episode):
            ...
            os.system("python3 compress_classifier.py --arch simplenet_cifar ../../../data.cifar --quantize-eval --compress ./cifar_bn_wrpn.yaml --epochs 10 --resume ./simplenet_cifar.pth.tar")
